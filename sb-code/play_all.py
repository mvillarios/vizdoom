...
MODEL_PATHS = {
    #"dqn": {"model": "dqn_vizdoom", "num": 3, "subfolder": "saves"},  # dqn usa "dqn_vizdoom" en la subcarpeta "saves"
    "dqn": {"model": "best_model", "num": 3, "subfolder": "models"},  # dqn usa "best_model" en la subcarpeta "models"
    "ppo": {"model": "best_model", "num": 6, "subfolder": "models"}   # ppo usa "best_model" en la subcarpeta "models"
}
